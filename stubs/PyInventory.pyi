...
class PyInventory:
    ...
    def GetInventoryIDFromAgent(self, agent_id: int) -> int: ...
    def IsInventoryIDValid(self, inventory_id: int) -> bool: ...
    def GetEquippedItemID(self, inventory_id: int, equip_slot: int) -> int: ...
    def GetUpgradeSlot(self, upgrade_item_id: int) -> int: ...
    def ValidateUpgrade(self, target_item_id: int, upgrade_item_id: int) -> bool: ...
    def ApplyUpgrade(self, inventory_id: int, target_item_id: int, upgrade_item_id: int, upgrade_slot: int = 0, target_agent_id: int = 0) -> bool: ...
